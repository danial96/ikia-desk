            ...
            <a href="{{ route('tasks.show', $task) }}"
               ...
               onmouseover="this.style.background='rgba(255,255,255,.05)'" onmouseout="this.style.background=''">
                ...
                <span style="font-size:11px;padding:3px 8px;border-radius:6px;font-weight:500;flex-shrink:0;
                     background:{{ ['new'=>'rgba(148,163,184,.15)','pending'=>'rgba(56,189,248,.18)','in_progress'=>'rgba(27,114,232,.2)','reviewing'=>'rgba(139,92,246,.22)','paused'=>'rgba(251,191,36,.2)','completed'=>'rgba(34,197,94,.15)'][$task->status] ?? 'rgba(148,163,184,.15)' }};
                     color:{{ ['new'=>'#94a3b8','pending'=>'#7dd3fc','in_progress'=>'#60a5fa','reviewing'=>'#c4b5fd','paused'=>'#fde68a','completed'=>'#4ade80'][$task->status] ?? '#94a3b8' }};">
